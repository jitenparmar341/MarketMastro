...
- (void)viewDidLoad {
    ...
    BOOL isInternetAvailabel = [[MethodsManager sharedManager] isInternetAvailable];
...
{
    //Load webview with web link -ttp://admin.marketmastro.com/StaticPage/sPage?pagename=help
    NSString *urlNameInString = @"http://admin.marketmastro.com/StaticPage/sPage?pagename=help";
